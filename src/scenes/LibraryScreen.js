        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <TouchableOpacity onPress={() => setMusic(true)}>
                    <Text style={[styles.headerText, { color: music ? Colors.WHITE : Colors.GRAY_LIGHT_MED }]} >Music</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setMusic(false)}>
                    <Text style={[styles.headerText, { color: music ? Colors.GRAY_LIGHT_MED : Colors.WHITE }]} >Podcasts</Text>
                </TouchableOpacity>
            </View>
