...
const SongModal: FC<Props> = ({ trackData, playAudio, pauseAudio, progress, duration }) => {
  ...
  return (
    <Modal animationType="slide" visible={state.modalVisible} presentationStyle="fullScreen">
      {renderModal()}
    </Modal>
  );
};
